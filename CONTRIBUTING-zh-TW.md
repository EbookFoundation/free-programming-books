*閱讀其他語言版本的文件：[English](CONTRIBUTING.md)。*
...
2. 你不需要會 Git：如果你發現了一些有趣的東西 *尚未出现在此 repo* 中，請開一個[Issue](https://github.com/EbookFoundation/free-programming-books/issues)進行主題討論。
...
* 如果一個連結存在過期的證書/自簽名證書/SSL問題的任何其他類型：
  ...
  2. *leave it* ：如果没有http版本，但仍然可以通過https造訪連結，則在瀏覽器中添加異常或忽略警告。
