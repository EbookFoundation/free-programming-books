...
Dobrodošli v zbirki Brezplačne knjige o programiranju! Lepo pozdravljeni vsi novi programerji - tudi tisti, ki boste na Githubu ustvarili vaš prvi zahtevek potega (pull-request). Če ste eden izmed njih, vam pri tem lahko pomaga nekaj virov:
...
Če niste prepričani, da je vir, ki ga želite dodati, primeren za zbirko brezplačnih knjig o programiranju, preberite smernice v [CONTRIBUTING] (CONTRIBUTING.md).
