...
* [Python Crash Course (2nd Edition Sample)](https://ehmatthes.github.io/pcc/) - Eric Matthes (HTML)
...
* [Python Design Patterns](https://python-patterns.guide/) - Brandon Rhodes (HTML)
