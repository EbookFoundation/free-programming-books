...
-   [Database Design – 2nd Edition](https://opentextbc.ca/dbdesign01/) - Adrienne Watt (HTML, PDF, EPUB, MOBI) (CC BY)
...
-   [Rust for Rubyists](https://web.archive.org/web/20190520171322/http://www.rustforrubyists.com/book) - Steve Klabnik (HTML) _( :card_file_box: archived)_
...
-   [Sage](https://en.wikibooks.org/wiki/Sage) - Wikibooks _( :construction: in process)_
