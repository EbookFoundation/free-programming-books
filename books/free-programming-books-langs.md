...
* [Build Web Application with Golang](https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/) - astaxie (HTML) (CC BY-SA)
...
* [Essential Go](https://www.programming-books.io/essential/go/) - Krzysztof Kowalczyk, StackOverflow Contributors (HTML) (CC BY-SA)
* [Essentials of Go Programming](https://essentials-of-go-programming.readthedocs.io) - Baiju Muthukadan (HTML) (CC BY-SA)
* [Gin Web Framework](https://chenyitian.gitbooks.io/gin-web-framework/content/) (HTML)
* [Go 101](https://go101.org/article/101.html) - [@TapirLiu](https://twitter.com/TapirLiu) (HTML)
* [Go by Example](https://gobyexample.com) (HTML)
* [Go for Javascript Developers](https://github.com/bulim/go-for-javascript-developers) (HTML)
...
* [Learn Go in Y minutes](https://learnxinyminutes.com/docs/go/) (HTML)
* [Learn Go with Tests](https://quii.gitbook.io/learn-go-with-tests/) - Chris James (HTML)
* [Learning Go](https://miek.nl/go/) (HTML) (CC BY-NC-SA)
* [Let's learn Go!](http://go-book.readthedocs.io/en/latest/) (HTML) (CC BY-NC-SA)
...
* [Spaceship Go - A Journey to the Standard Library](https://blasrodri.github.io/spaceship-go-gh-pages/) - Blas Rodriguez Irizar (HTML)
* [The Go Tutorial](http://tour.golang.org) (HTML)
* [The Little Go Book](https://github.com/karlseguin/the-little-go-book) - Karl Seguin (HTML, [PDF](https://www.openmymind.net/assets/go/go.pdf), [ePUB](https://www.openmymind.net/assets/go/go.epub)) (CC BY-NC-SA)
* [Web apps in Go, the anti textbook](https://github.com/thewhitetulip/web-dev-golang-anti-textbook/) (HTML) (CC BY-SA)
