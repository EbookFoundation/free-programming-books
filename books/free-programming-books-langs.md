...
* [Automate the Boring Stuff with Python, 3rd Edition](https://automatetheboringstuff.com/3e/) - Al Sweigart - HTML (CC BY-NC-SA)
...
* [Building Skills in Object-Oriented Design, V4](https://slott56.github.io/building-skills-oo-design-book/build/html/) - Steven F. Lott (3.7)
  * [Release 2.2.1](https://web.archive.org/web/20150824204101/http://buildingskills.itmaybeahack.com/book/oodesign-python-2.2/latex/BuildingSkillsinOODesign.pdf) - PDF (2.2.1) (archived)
  * [Release 3.1](https://web.archive.org/web/20160322093622/http://buildingskills.itmaybeahack.com/book/oodesign-3.1/latex/BuildingSkillsinObject-OrientedDesign.pdf) - PDF (3.1) (archived)
* [Building Skills in Python](https://web.archive.org/web/20190918094202/http://www.itmaybeahack.com/book/python-2.6/latex/BuildingSkillsinPython.pdf) - Steven F. Lott - PDF (2.6) (archived)
* [Clean Architectures in Python](https://www.thedigitalcatbooks.com/pycabook-introduction/) - Leonardo Giordani (3.x) - PDF
* [Code Like a Pythonista: Idiomatic Python](https://web.archive.org/web/20180411011411/http://python.net/~goodger/projects/pycon/2007/idiomatic/handout.html) - David Goodger (archived)
...
* [Data Structures and Algorithms in Python](https://web.archive.org/web/20161016153130/http://www.brpreiss.com/books/opus7/html/book.html) - B. R. Preiss - PDF (archived)
...
* [Dive into Python 3](https://diveintopython3.problemsolving.io) - Mark Pilgrim (3.x) (CC BY-SA)
...
* [Fundamentals of Python Programming](https://web.archive.org/web/20191005170430/http://python.cs.southern.edu/pythonbook/pythonbook.pdf) - Richard L. Halterman - PDF (in process)
...
* [Google's Python Class](https://developers.google.com/edu/python/) - 2.x
...
* [How to Think Like a Computer Scientist: Learning with Python, Interactive Edition](https://runestone.academy/runestone/books/published/thinkcspy/index.html) - Brad Miller, David Ranum, Jeffrey Elkner, Peter Wentworth, Allen B. Downey, Chris Meyers, Dario Mitchell - 3.2
  * [1st Edition](https://greenteapress.com/wp/learning-with-python/) - Allen B. Downey, Jeff Elkner, Chris Meyers (2.4) - HTML, PDF (GFDL)
  * [2nd Edition](https://openbookproject.net/thinkcs/python/english2e/) - Jeffrey Elkner, Allen B. Downey, Chris Meyers - Python 2.x
  * [3rd Edition AoPS](https://artofproblemsolving.com/assets/pythonbook/) - AoPS Incorporated, Peter Wentworth, Jeffrey Elkner, Allen B. Downey, Chris Meyers - HTML
  * [3rd Edition RLE](https://openbookproject.net/thinkcs/python/english3e/) - Peter Wentworth, Jeffrey Elkner, Allen B. Downey, Chris Meyers - PDF
...
* [Introduction to Programming with Python](http://opentechschool.github.io/python-beginners/en/) - 3.x
  * [Introduction to Programming Using Python](http://python-ebook.blogspot.co.uk) - Cody Jackson - 1st edition (2.3)
* [Introduction to Python](http://kracekumar.com/post/71171551647/introduction-to-python) - 2.7.3
...
* [Learn Python in Y minutes](https://learnxinyminutes.com/docs/python/) - HTML
...
* [Real Python Tutorials](https://realpython.com/tutorials/python/) - Real Python Team - HTML
