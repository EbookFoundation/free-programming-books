...
- [Blockchain and Crypto Currency](https://library.oapen.org/handle/20.500.12657/37713) - Mateusz Mucha (PDF) `(CC BY-NC-ND)`
...
- [Blockchain E-Textbook](https://vtechworks.lib.vt.edu/bitstreams/3f7a3aa4-f44f-429a-9249-59a0ca285417/download) - VTechWorks OpenDSA Project (PDF) `(CC BY)`
- [Blockchain for Dummies, 2nd IBM Limited Edition](https://www.ibm.com/downloads/cas/36KBMBOG) - Manav Gupta (PDF)
- [Blockchain Technology Overview](https://nvlpubs.nist.gov/nistpubs/ir/2018/nist.ir.8202.pdf) - Dylan Yaga, Peter Mell, Nik Roby, Karen Scarfone (PDF) `(Public Domain - NIST)`
...
- [Cryptology with Bitcoin and Blockchain Applications](https://rdw.rowan.edu/textbooks/1) - Christopher Woodall (PDF) `(CC BY)`
