...
* [A Primer on Design Patterns](https://leanpub.com/aprimerondesignpatterns) - Rahul Batra ([HTML](https://leanpub.com/aprimerondesignpatterns/read), PDF, EPUB, Kindle) *(Leanpub account or valid email requested)*
