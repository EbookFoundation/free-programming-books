...
* [Dotnet Microservices Architecture for Containerized NET Applications](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/container-docker-introduction/) - Cesar de la Torre, Bill Wagner, Mike Rousos (HTML, PDF)
