...
* [Deploying Spring Boot Applications With AWS ECS Fargate (Free Course) - Course Outline](https://javatodev.com/deploying-spring-boot-applications-with-aws-ecs/) - Chinthaka Dinadasa (javatodev)
    1. [Setting Up AWS VPC For Fargate Deployment](https://javatodev.com/setting-up-aws-vpc-for-fargate-deployment/)
    2. [Publishing Docker Images On Amazon ECR](https://javatodev.com/using-amazon-ecr-for-publishing-docker-images/)
    3. [Deploying Amazon RDS MySQL Database](https://javatodev.com/deploying-amazon-rds-mysql-database/)
    4. [Creating Security Groups For ECS Deployment](https://javatodev.com/creating-security-groups-for-ecs-deployment/)
    5. [Creating Security Groups For ECS Deployment](https://javatodev.com/creating-security-groups-for-ecs-deployment/)
    6. [Creating Cluster For ECS Fargate Deployment](https://javatodev.com/creating-ecs-cluster-for-fargate-deployment/)
    7. [Creating Task Definitions For ECS Deployment](https://javatodev.com/creating-task-definitions-for-ecs-deployment/)
    8. [Deploying Service To The ECS Fargate](https://javatodev.com/service-deployment-ecs-cluster/)
