...
- insert your links in alphabetical order. When there are multiple titles beginning with the same letter order them by the second, and so on. If you see a misplaced link, please reorder it and submit a PR
...
- No emoji or "weird" characters. The reading must be uniform.
