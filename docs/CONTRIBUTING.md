...
- We don't accept files hosted on _Google Drive_, _Dropbox_, _Mega_, _Scribd_, _Issuu_ and other similar file upload platforms
...
- Use the link with the most authoritative source (meaning the author's website is better than the editor's website, which is better than a third-party website).
    - No file hosting services (this includes (but is not limited to) _Dropbox_ and _Google Drive_ links)
