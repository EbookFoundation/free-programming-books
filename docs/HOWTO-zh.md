...
不要犹豫，提问题。每个贡献者都从第一个 PR 开始。你可能是我们的千分之一！所以，为什么不加入我们这个[庞大且不断增长的](https://www.apiseven.com/en/contributor-graph?chart=contributorOverTime&repo=ebookfoundation/free-programming-books)社区呢？

<details align="center" markdown="1">
<summary>点击查看用户与时间的增长图表。</summary>
...
即使您是经验丰富的开源贡献者，也有一些事情可能会让您绊倒。提交您的 PR 后，***GitHub Actions* 会运行一个 *linter*（代码风格检测工具），经常发现间距或字母顺序方面的小问题**。如果您获得绿色按钮，则说明一切准备就绪；如果没有，请单击失败检查下方的“Details”来查看 linter 不满意的地方，并在对应分支上提交一个新的 commit 来修复它。
